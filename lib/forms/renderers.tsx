...
export const titleRenderer = ({ title }: { title: string }) => (
    ...
    // className={formStyles.headerFlex}
    />
);

interface SaveButtonRendererProps {
    save?: () => void;
    isSaved: boolean;
    hasError: boolean;
    isDirty: boolean;
    ...
    render() {
        ...
        return (
            <Form
                ...
                formContext={{ subTitle: props.subTitle, isDirty: props.isDirty }}
                fields={props.fields}
                formData={props.data}
                onSubmit={props.save}
                ...
                showErrorList={isTruthyWithDefault(props.ui ? props.ui.showErrorList : false, false)}
                // tslint:disable-next-line:no-any
